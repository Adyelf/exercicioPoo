			...
			if (escolha == 3) {
				...
				if (escolhaCategoria == 1) {
					for (int i = 0; i < categoriaUm.size(); i++) {
						System.out.println("Atualmente temos " + categoriaUm.size() + " carros disponíveis");
				...
				if (escolhaCategoria == 2) {
					for (int i = 0; i < categoriaDois.size(); i++) {
						System.out.println("Atualmente temos " + categoriaDois.size() + " carros disponíveis");
				...
				if (escolhaCategoria == 3) {
					for (int i = 0; i < categoriaTres.size(); i++) {
						System.out.println("Atualmente temos " + categoriaTres.size() + " carros disponíveis");
						System.out.println("Carro número " + (i + 1) + categoriaTres);
					}
					System.out.println("-----------------------------------------");
				} if (escolhaCategoria != 1 && escolhaCategoria !=2 && escolhaCategoria !=3) {
					System.out.println("Você digitou uma categoria que não existe por enquanto ");
					System.out.println("-----------------------------------------");
				}
